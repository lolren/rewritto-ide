...
void TestPlatformFilterProxyModel::filtersByShowMode() {
  ...
  addPlatform(&model, QStringLiteral("blingblink:avr"), QStringLiteral("1.8.6"),
              QStringLiteral("1.8.6"));
  addPlatform(&model, QStringLiteral("blingblink:samd"), QStringLiteral("1.8.13"),
  ...
  QCOMPARE(proxy.rowCount(), 1);
  QCOMPARE(proxy.index(0, 0).data().toString(), QStringLiteral("blingblink:samd"));
}
...
void TestPlatformFilterProxyModel::filtersByVendorAndArchitecture() {
  ...
  proxy.setVendorFilter(QStringLiteral("BlingBlink"));
  QCOMPARE(proxy.rowCount(), 2);

  proxy.setArchitectureFilter(QStringLiteral("avr"));
  QCOMPARE(proxy.rowCount(), 1);
  QCOMPARE(proxy.index(0, 0).data().toString(), QStringLiteral("blingblink:avr"));
...
void TestPlatformFilterProxyModel::filtersByType() {
  QStandardItemModel model;
  model.setColumnCount(4);
  addPlatformWithTypes(&model, QStringLiteral("blingblink:avr"), QStringLiteral("1.8.6"),
                       QStringLiteral("1.8.6"), {QStringLiteral("Arduino")});
  addPlatformWithTypes(&model, QStringLiteral("blingblink:samd"), QStringLiteral("1.8.13"),
                       QStringLiteral("1.8.14"),
