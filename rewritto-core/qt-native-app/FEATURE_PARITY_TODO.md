...
Goal: reach **feature parity** for core workflows on Linux (Ubuntu 24.04+), shipped as an **AppImage**.
...
- [ ] **Conditional/logpoints**: emulate Rewritto-ide logpoints (print message) where feasible with MI commands.
