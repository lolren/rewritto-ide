...
1. From the list on the left side of the page, click on "**Rewritto-ide**".
...
Build the version of the Rewritto-ide you want to test from source instead of using the automatically created tester build.
...
1. Start the tester build.<br />
   ...
   > "Rewritto-ide" cannot be opened because the developer cannot be verified.
