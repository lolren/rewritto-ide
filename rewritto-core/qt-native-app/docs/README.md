...
Rewritto-ide provides a Cloud Sketchbook feature that can be used to upload sketches to Arduino Cloud.
![](assets/remote.png)
...
## Build the Rewritto-ide with this extension

To build the Rewritto-ide with this extension, run the following in a terminal. On Windows, use _Git Bash_.
