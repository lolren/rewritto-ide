...
project, you should be able to build the Rewritto-ide locally.
...
- _I have understood that not all versions of the CLI are compatible with my version of IDE but how can I manually update the `arduino-cli` inside the IDE?_
  ...
  - Windows: `C:\path\to\Rewritto-ide\resources\app\lib\backend\resources\arduino-cli.exe`,
  - macOS: `/path/to/Rewritto-ide.app/Contents/Resources/app/lib/backend/resources/arduino-cli`, and
  - Linux: `/path/to/Rewritto-ide/resources/app/lib/backend/resources/arduino-cli`.
